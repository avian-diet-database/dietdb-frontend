import { FetchResult, fromPromise, MutationFunctionOptions } from "@apollo/client";
...
export const DesignSubmitData = (props: DesignSubmitDataProps) => {
    ...
    function submitForm(targetPage: string) {
        ...
        props.addData({
            variables: {
                common_name: formData.studyInfo.common_name,
                scientific_name: "Struthio camelus",
                subspecies: formData.studyInfo.subspecies,
                family: formData.studyInfo.family,
                taxonomy: "Sida",
                longitude_dd: formData.studyInfo.longitude_dd,
                latitude_dd: formData.studyInfo.latitude_dd,
                altitude_min_m: formData.studyInfo.altitude_min_m,
                altitude_max_m: formData.studyInfo.altitude_max_m,
                altitude_mean_m: formData.studyInfo.altitude_mean_m,
                location_region: formData.studyInfo.location_region,
                location_specific: formData.studyInfo.location_specific,
                habitat_type: "ENTER HABITAT TYPE HERE",
                observation_month_begin: 1,
                observation_month_end: 1,
                observation_year_begin: 1,
                observation_year_end: 1,
                observation_season: "Winter",
                analysis_number: formData.studyInfo.analysis_number,
                prey_kingdom: formData.studyInfo.prey_kingdom,
                prey_phylum: formData.studyInfo.prey_phylum,
                prey_class: formData.studyInfo.prey_class,
                prey_order: formData.studyInfo.prey_order,
                prey_suborder: formData.studyInfo.prey_suborder,
                prey_family: formData.studyInfo.prey_family,
                prey_genus: formData.studyInfo.prey_genus,
                prey_scientific_name: formData.studyInfo.prey_scientific_name,
                inclusive_prey_taxon: formData.studyInfo.inclusive_prey_taxon,
                prey_name_ITIS_ID: formData.studyInfo.prey_name_ITIS_ID,
                prey_name_status: formData.studyInfo.prey_name_status,
                prey_stage: "ENTER prey stage HERE",
                prey_part: "ENTER prey part HERE",
                prey_common_name: formData.studyInfo.common_name,
                fraction_diet: formData.studyInfo.fraction_diet,
                diet_type: formData.studyInfo.diet_type,
                item_sample_size: 1,
                bird_sample_size: 1,
                sites: formData.studyInfo.sites,
                study_type: formData.studyInfo.study_type,
                notes: formData.studyInfo.notes,
                ...
                doi: formData.studyInfo.doi,
                sex: formData.studyInfo.sex,
                age_class: "string",
                within_study_data_source: formData.studyInfo.within_study_data_source,
                table_fig_number: formData.studyInfo.table_fig_number,
                title: formData.studyInfo.title,
                lastname_author: formData.studyInfo.lastname_author,
                year: 1,
                journal: formData.studyInfo.journal,
                total_percent_diet: formData.studyInfo.total_percent_diet,
                new_species: true,
            }
        });
            ...
            <div id="page5" style={styles.formContainerPg5}>
                ...
                <div style={styles.reviewInfoContainer}>
                    ...
                    <div>
                        ...
                        <p id="required" style={{ ...styles.questionTextSize }}>2. What bird species are you entering diet data for? <span style={styles.green}>*</span></p>
                        <p>{new_species_yn === 'yes' ? 'Scientific Name: ' + scientific_name + '; Common Name: ' + common_name + '; Family: ' + family + '; Taxonomy: ' + taxonomy : 'Scientific Name: ' + scientific_name}</p>
                        <p id="required" style={{ ...styles.questionTextSize }}>3. Was the data collected from within a single state, province, or country? <span style={styles.green}>*</span></p>
